...
public void renderItems() {
	...
	for (ItemStack i : this.items){
		if (i != null){
			...
			if (items[0] != null){				
		    GL11.glDisable(GL11.GL_LIGHTING);					
			this.irender.renderItemIntoGUI(this.fontRenderer, this.mc.getTextureManager(), items[0], x - 3, y);
			GL11.glEnable(GL11.GL_LIGHTING);			
			}	
			if (items[1] != null){
			    GL11.glDisable(GL11.GL_LIGHTING);	
			this.irender.renderItemIntoGUI(this.fontRenderer, this.mc.getTextureManager(), items[1], x + 18, y);
				GL11.glEnable(GL11.GL_LIGHTING);	
			}
			if (items[2] != null){
			    GL11.glDisable(GL11.GL_LIGHTING);	
			this.irender.renderItemIntoGUI(this.fontRenderer, this.mc.getTextureManager(), items[2], x + 40, y);
			GL11.glEnable(GL11.GL_LIGHTING);	
			}
			if (items[3] != null){
			    GL11.glDisable(GL11.GL_LIGHTING);	
			this.irender.renderItemIntoGUI(this.fontRenderer, this.mc.getTextureManager(), items[3], x - 3, y + 21);
			GL11.glEnable(GL11.GL_LIGHTING);	
			}
			if (items[4] != null){
			    GL11.glDisable(GL11.GL_LIGHTING);	
			this.irender.renderItemIntoGUI(this.fontRenderer, this.mc.getTextureManager(), items[4], x + 18, y + 21);
			GL11.glEnable(GL11.GL_LIGHTING);	
			}
			if (items[5] != null){
			    GL11.glDisable(GL11.GL_LIGHTING);	
			this.irender.renderItemIntoGUI(this.fontRenderer, this.mc.getTextureManager(), items[5], x + 40, y + 21);
			GL11.glEnable(GL11.GL_LIGHTING);	
			}
			if (items[6] != null){
			    GL11.glDisable(GL11.GL_LIGHTING);	
			this.irender.renderItemIntoGUI(this.fontRenderer, this.mc.getTextureManager(), items[6], x - 3, y + 43);
			GL11.glEnable(GL11.GL_LIGHTING);	
			}
			if (items[7] != null){
			    GL11.glDisable(GL11.GL_LIGHTING);	
			this.irender.renderItemIntoGUI(this.fontRenderer, this.mc.getTextureManager(), items[7], x + 18, y + 43);
			GL11.glEnable(GL11.GL_LIGHTING);	
			}
			if (items[8] != null){
			    GL11.glDisable(GL11.GL_LIGHTING);	
			this.irender.renderItemIntoGUI(this.fontRenderer, this.mc.getTextureManager(), items[8], x + 40, y + 43);
			GL11.glEnable(GL11.GL_LIGHTING);	
			}
			   //Itemstack 9 is the output slot
			if (items[9] != null){
				GL11.glDisable(GL11.GL_LIGHTING);	
			this.irender.renderItemIntoGUI(this.fontRenderer, this.mc.getTextureManager(), items[9], x + 19, y - 44);
			GL11.glEnable(GL11.GL_LIGHTING);	
			}
...
/*
			...
			int a;
			for(a = 0; a < 1; a++){
			this.irender.renderItemIntoGUI(this.fontRenderer, this.mc.getTextureManager(), i, x - 4, y);
			x += 22;
			}
