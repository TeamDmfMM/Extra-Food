...
public class BananaWorldGenTrees extends WorldGenerator {
    ...
    public BananaWorldGenTrees(boolean par1)
    {
        this(par1, 4, 0, 0, false);
    }

    public BananaWorldGenTrees(boolean par1, int par2, int par3, int par4, boolean par5)
    {
        super(par1);
                        ...
                        for (j1 = par4 - 3 + l; j1 <= par4 + l; ++j1)
                        {
                            ...
                            for (j2 = par3 - i2; j2 <= par3 + i2; ++j2)
                            {
                                for (k2 = par5 - i2; k2 <= par5 + i2; ++k2)
                                {
                                    ...
                                    {
                                        if (par2Random.nextInt(25) == 0 && par1World.isAirBlock(j2, j1 - 1, k2))
                                        {
                                            this.growVines(par1World, j2, j1 - 1, k2, 1);
                                        }

                                        if (par2Random.nextInt(15) == 0 && par1World.isAirBlock(j2, j1 - 1, k2))
                                        {
                                            this.growVines(par1World, j2, j1 - 1, k2, 1);
                                        }
    ...
    {
        this.setBlockAndMetadata(par1World, par2, par3, par4, BlockLoader.bananaBunch.blockID, par5);
    }
}
