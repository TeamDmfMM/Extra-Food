	        ...
	        if (!Double.isNaN(v2.xCoord) && !Double.isNaN(v2.yCoord) && !Double.isNaN(v2.zCoord))
	        {
	            ...
	            while (k1-- >= 0)
	            {
	                ...
	                if (!bool2 || block1.getBlock().getCollisionBoundingBox(world, new BlockPos(l, i1, j1), block1) != null)
	                {
	                    ...
	                    {
	                        RayTraceResult movingobjectposition1 = block1.getBlock().collisionRayTrace(world, new BlockPos(l, i1, j1), v1, v2);
	                    ...
	                    {
	                        movingobjectposition2 = new RayTraceResult(RayTraceResult.MovingObjectType.MISS, v1, enumfacing, new BlockPos(l, i1, j1));
	                    }
	                }
	            }
