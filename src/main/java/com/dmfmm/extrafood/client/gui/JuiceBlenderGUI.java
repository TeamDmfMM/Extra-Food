...
import com.dmfmm.extrafood.container.JuiceBlenderContainer;
...
public class JuiceBlenderGUI extends GuiContainer {

    private JuiceBlenderTileEntity te;
    ...
    public JuiceBlenderGUI(InventoryPlayer player, JuiceBlenderTileEntity tilentity) {
        super(new JuiceBlenderContainer(player, tilentity));
        te = tilentity;
    ...
    protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
        ...
        this.mc.renderEngine.bindTexture(GuiLib.JUICE_BLENDER_GUI);
        int x = (width - xSize) / 2;
        int y = (height - ySize) / 2;
