...
import com.dmfmm.extrafood.client.models.AutoCutterModel;
...
public class AutoCutterRender extends TileEntitySpecialRenderer {

    //The model of your block
    private static final AutoCutterModel model = new AutoCutterModel();

    public AutoCutterRender() {
    }
