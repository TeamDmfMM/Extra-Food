...
public class EdibleBucket extends ItemBucket {
	
	private int FoodStat;
	private float SaturationLvl;
	
	public EdibleBucket(int foodBar, float saturation, Block placedBlock, String name){
		super(placedBlock);
		this.setCreativeTab(EFTabs.INSTANCE);
		this.setUnlocalizedName(name);
		this.setTextureName("extrafood:bucket_" + name);
