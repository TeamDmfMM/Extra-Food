    ...
    public boolean generate(World world, Random rand, BlockPos pos)
    {
        ...
        if (y >= 1 && y + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = block2.canSustainPlant(world, pos.down().down(), EnumFacing.UP, (BlockSapling)Blocks.sapling);
                if (isSoil && y < 256 - 4 - 1) {
                    block2.onPlantGrow(world, new BlockPos(x, y - 1, z).down(), new BlockPos(x, y, z).down());
