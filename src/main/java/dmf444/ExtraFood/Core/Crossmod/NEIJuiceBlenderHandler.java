...
public class NEIJuiceBlenderHandler extends TemplateRecipeHandler{
	...
	public String getGuiTexture() {
	  ...
	  public void drawExtras(int recipeI){
		  ...
		  ResourceLocation juice = new ResourceLocation(JuiceRegistry.instance.getTextureFromJuice(JuiceRegistry.instance.getJuiceFromItemStack(arecipes.get(recipeI).getIngredient().item)));
		  renderEngine.bindTexture(juice);
		  gui.drawTexturedModalRect(147 - 5, (int)((62 - (1000 * 0.012)) - 1), 0, 0, 16, (int)(1000 * 0.012));
